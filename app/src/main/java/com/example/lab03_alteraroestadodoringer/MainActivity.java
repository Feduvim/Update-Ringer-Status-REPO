package com.example.lab03_alteraroestadodoringer;
...
//Construímos o intent que nos permite aceder às permissões que temos de dar app.
            Intent intent =
                    new
        ...
        {
//Manter o código dado anteriormente e adicionar o seguinte:
        verificaEstadoRinger();
        alteraIconSonoro();
        }
    }
